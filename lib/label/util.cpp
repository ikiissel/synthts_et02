...
//    if (s == L"end") return explode(L"endine", sp, a);
	...
	if (s == L"mm") return explode(L"millimeeter", sp, a);
	if (s == L"cm") return explode(L"sentimeeter", sp, a);
	if (s == L"dm") return explode(L"detsimeeter", sp, a);
	if (s == L"km") return explode(L"kilomeeter", sp, a);
	
	if (s == L"l") return explode(L"liiter", sp, a);
	if (s == L"ml") return explode(L"milliliiter", sp, a);
	if (s == L"dl") return explode(L"detsiliiter", sp, a);
	...
	if (s == L"km/h") return explode(L"kilomeetrit tunnis", sp, a);
	if (s == L"km/t") return explode(L"kilomeetrit tunnis", sp, a);
//	if (s == L"") return explode(L"", sp, a);
